...
create table tb_product (id bigint generated by default as identity, date TIMESTAMP WITHOUT TIME ZONE, description TEXT, img_url varchar(255), name varchar(255), price float, primary key (id));
...
create table tb_sale (id bigint generated by default as identity, value float, user_id bigint, primary key (id));
create table tb_sale_product (sale_id bigint not null, product_id bigint not null);
create table tb_target (id bigint generated by default as identity, amount integer, value float, user_id bigint, primary key (id));
